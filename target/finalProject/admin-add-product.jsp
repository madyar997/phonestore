...
<div class="container col-md-5">
    <div class="card">
        <div class="card-body">
            <form action="/phonestore/admin/product-management/add" method="post">
                <caption>
                    <h2><fmt:message key="label.add_item"/></h2>
                </caption>
                ...
                <button type="submit" class="btn btn-success"><fmt:message key="label.add_item"/></button>
            </form>
        </div>
    </div>
</div>
