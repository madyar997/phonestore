...
public class AdminProductEditService implements Service {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException, SQLException {
        ...
        phone.setId(Integer.parseInt(request.getParameter(Constants.ID)));
        ...
        characteristics.setId(phoneDao.getCharacteristicsIdByphoneId(phone.getId()));
